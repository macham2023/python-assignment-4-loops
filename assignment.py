...
#grouping the students into 3 groups
...
for student in students:
    ...
    name = student["name"]
    score = student["score"]
#Grouping the students based on there scores

    student_record = {student_id:(name,score)}
    if score >= 70:
        high_performers.append(student_record)
...
# to know the average performers
print(f"All average performers are: ,{average_performers}")

# to know all the low performers
print(f"All low performers are:, {low_performers}")
